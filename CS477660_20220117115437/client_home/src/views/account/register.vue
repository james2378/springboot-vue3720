						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--家政用户-->
									<form_housekeeping_user v-if="form.user_group === '家政用户'" :form="form_sub"></form_housekeeping_user>
...
<script>
	...
	/* 家政用户 */
	import form_housekeeping_user from "@/components/diy/form_housekeeping_user";
